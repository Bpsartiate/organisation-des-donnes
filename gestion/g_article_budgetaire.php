...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12">
      <strong  class="fs-1" >Gestion des articles budgetaires</strong>
    </div>
    <br>
              <br>
              <br>
  ...
  <div class="row">
          ...
          <div class="card-content">
            ...
            <div class="row titre">
            <span class="ajoutter" ><h3>Ajouter un nouvel Article </h3><a href="#"><i class="fa-solid fa-circle-plus btn primary "title="Ajouter un nouvel Article" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop"></i></a></span>
